...
\begin{Figure}
 ...
 \captionof{figure}{Simulation of underdamped free vibration with $m = 10$, $k = 2.5$, $\gamma = 15$, $y_0 = 10$, $v_0 = 10$, over the period $t = [0, 20]$}
\end{Figure}
...
\begin{Figure}
 ...
 \captionof{figure}{Simulation of underdamped free vibration with $m = 10$, $k = 2.5$, $\gamma = 10$, $y_0 = 10$, $v_0 = 10$, over the period $t = [0, 20]$}
\end{Figure}
